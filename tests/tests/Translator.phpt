...
class Translator extends Contributte\Translation\Tests\AbstractTest
{
	...
	public function test02(): void
	{
		...
		Tester\Assert::same('Hello', $translator->translate(new Contributte\Translation\Message('hello')));
		Tester\Assert::same('Hello', $translator->translate('//messages.hello'));
		Tester\Assert::same('Hello', $translator->translate(new Contributte\Translation\Message('//messages.hello')));
		Tester\Assert::same('Hello', $translator->translate('hello', [], 'messages', 'en'));
		Tester\Assert::same('Hello', $translator->translate(new Contributte\Translation\Message('hello', [], 'messages', 'en')));
		Tester\Assert::same('Hello', $translator->translate('hello', null, [], 'messages', 'en'));
		Tester\Assert::same('Hello', $translator->translate(new Contributte\Translation\Message('hello', null, [], 'messages', 'en')));
		Tester\Assert::same('Hi Ales!', $translator->translate('messages.hi', ['name' => 'Ales']));
		Tester\Assert::same('Hi Ales!', $translator->translate(new Contributte\Translation\Message('messages.hi', ['name' => 'Ales'])));
		Tester\Assert::same('Hi Ales!', $translator->translate('hi', ['name' => 'Ales']));
		Tester\Assert::same('Hi Ales!', $translator->translate(new Contributte\Translation\Message('hi', ['name' => 'Ales'])));
		Tester\Assert::same('Hi Ales!', $translator->translate('//messages.hi', ['name' => 'Ales']));
		Tester\Assert::same('Hi Ales!', $translator->translate(new Contributte\Translation\Message('//messages.hi', ['name' => 'Ales'])));
		Tester\Assert::same('Hi Ales!', $translator->translate('hi', ['name' => 'Ales'], 'messages', 'en'));
		Tester\Assert::same('Hi Ales!', $translator->translate(new Contributte\Translation\Message('hi', ['name' => 'Ales'], 'messages', 'en')));
		Tester\Assert::same('Hi Ales!', $translator->translate('hi', null, ['name' => 'Ales'], 'messages', 'en'));
		Tester\Assert::same('Hi Ales!', $translator->translate(new Contributte\Translation\Message('hi', null, ['name' => 'Ales'], 'messages', 'en')));
